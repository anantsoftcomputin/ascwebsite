# Generated by Django 3.2.5 on 2021-12-17 05:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('testing_app', '0047_alter_user_budget'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('1000'), default_currency='USD', max_digits=14)),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project', models.CharField(default='', max_length=264)),
                ('option', models.CharField(default='', max_length=264)),
                ('homepage', models.IntegerField(default=1)),
                ('innerpages', models.IntegerField(default=1)),
                ('html_options', models.CharField(max_length=264)),
                ('cms_options', models.CharField(max_length=264)),
                ('frontend_options', models.CharField(max_length=264)),
            ],
        ),
